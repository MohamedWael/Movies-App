...
import com.github.mohamedwael.movieapp.modules.moviedetails.datasource.MovieByIdDataSourceImpl
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        MovieDetailsViewModelFactory.inject(MovieByIdRepo(MovieByIdDataSourceImpl()))
    }
}